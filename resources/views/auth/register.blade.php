            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Address -->
                        <div class="form-group row">
                            <label class="col-form-label col-md-4 col-sm-3 label-align" for="address">Address *</label>
                            <div class="col-md-6">
                        ...
                        <!-- Phone -->
                        <div class="form-group row">
                            <label class="col-form-label col-md-4 col-sm-3 label-align" for="phone_number">Phone Number*</label>
